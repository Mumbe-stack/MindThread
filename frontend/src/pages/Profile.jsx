...
// Mock navigation and auth functions for demo
...
const useAuth = () => ({
  ...
  token: "sample-token",
  loading: false,
  deleteUser: async () => console.log("Delete user")
});
  ...
  return (
    <label className="block w-full">
      <input
        ...
        className="sr-only"
      />
      <div className="cursor-pointer inline-flex items-center justify-center w-full px-4 sm:px-6 py-3 border border-gray-300 text-sm sm:text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-sm">
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-4 sm:py-6 lg:py-8">
      <div className="max-w-4xl mx-auto px-3 sm:px-4 lg:px-6">
        ...
        <div className="bg-white shadow-sm rounded-lg p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-900">Your Profile</h2>
            <button
              onClick={handleRefreshProfile}
              className="inline-flex items-center justify-center px-3 sm:px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 transition-colors"
        ...
        {/* Profile Information with Avatar - Responsive layout */}
        <div className="bg-white shadow-sm rounded-lg p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6">
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-4 sm:p-6 rounded-lg border border-gray-200">
            <div className="flex flex-col sm:flex-row sm:items-start gap-4 sm:gap-6 mb-4 sm:mb-6 pb-4 sm:pb-6 border-b border-gray-200">
              {/* Avatar Display - Responsive sizing */}
              <div className="flex justify-center sm:justify-start">
                <div className="relative">
                  <div className="w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 rounded-full overflow-hidden bg-gray-200 border-3 sm:border-4 border-white shadow-lg">
                    {avatarUrl ? (
                      <img 
                    ...
                    >
                      <svg className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex-1 text-center sm:text-left">
                ...
                <p className="text-gray-600 mb-3 text-sm sm:text-base break-all sm:break-normal">{user.email}</p>
        ...
        <div className="bg-white shadow-sm rounded-lg p-4 sm:p-6 lg:p-8 mb-4 sm:mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <button
              ...
              className="inline-flex items-center justify-center w-full px-4 sm:px-6 py-3 border border-transparent text-sm sm:text-base font-medium rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors shadow-sm"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="inline-flex items-center justify-center w-full px-4 sm:px-6 py-3 border border-gray-300 text-sm sm:text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors shadow-sm"
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Avatar Upload Button - Responsive */}
            <AvatarUploader onUploadSuccess={fetchFullUserProfile} />
            
            {user.is_admin && (
              <button
                onClick={() => navigate("/admin")}
                className="inline-flex items-center justify-center w-full px-4 sm:px-6 py-3 border border-transparent text-sm sm:text-base font-medium rounded-lg text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors shadow-sm"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Recent Activity Preview - MOVED TO AFTER DELETE BUTTON */}
                  ...
                  <div className="space-y-2">
                    {fullUserData.recent_posts.slice(0, 3).map((post) => (
                      <div key={post.id} className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 p-3 bg-gray-50 rounded-lg">
                        <span className="text-indigo-600 hover:text-indigo-800 cursor-pointer font-medium text-sm sm:text-base line-clamp-2 sm:line-clamp-1">
                          {post.title}
                        </span>
                  ...
                  <div className="space-y-2">
                    {fullUserData.recent_comments.slice(0, 2).map((comment) => (
                      <div key={comment.id} className="p-3 bg-gray-50 rounded-lg">
                        <p className="text-gray-700 text-xs sm:text-sm mb-2 line-clamp-3">{comment.content}</p>
