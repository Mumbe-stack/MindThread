  ...
  return (
    <label className="block w-full">
      <input
        ...
        className="sr-only"
      />
      <div className="cursor-pointer w-full flex items-center justify-center px-4 py-3 border border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors shadow-sm">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6">
        ...
        <div className="bg-white shadow-lg rounded-lg p-6 mb-6">
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-lg border border-gray-200">
            ...
            <div className="flex flex-col items-center space-y-6 md:flex-row md:items-start md:space-y-0 md:space-x-6 mb-6 pb-6 border-b border-gray-200">
              {/* Avatar */}
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-gray-600 mb-2 break-words">{user.email}</p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6 mb-6 shadow-sm">
          ...
          <div className="space-y-4">
            <button
              ...
              className="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors shadow-sm"
            >
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="w-full inline-flex items-center justify-center px-6 py-3 border border-gray-300 text-base font-medium rounded-lg text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-colors shadow-sm"
            >
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {user.is_admin && (
              <button
                ...
                className="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent text-base font-medium rounded-lg text-white bg-purple-600 hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 transition-colors shadow-sm"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Danger Zone */}
        <div className="bg-white border border-red-200 rounded-lg p-6 shadow-sm mb-6">
                  ...
                  <div className="space-y-2">
                    {fullUserData.recent_posts.slice(0, 3).map((post) => (
                      <div key={post.id} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                        <span className="text-indigo-600 hover:text-indigo-800 cursor-pointer font-medium flex-1 truncate">
                          {post.title}
                        </span>
